...
<head>
  ...
  <link href="/dash/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="/dash/assets/css/soft-ui-dashboard.css?v=1.0.3" rel="stylesheet" />

  <link id="pagestyle" href="/dash/assets/css/sweetalert2.min.css" rel="stylesheet" />
  ...
  ?>
  <title>
    <?php echo $page_title; ?> - Mascula Club Khenchela University
  </title>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Mascula Dashboard</h5>
  ...
  <script src='{{asset("/dash/custom/global.js")}}'></script>

  <!-- Github buttons -->
  <script async defer src="https://buttons.github.io/buttons.js"></script>
  <!-- Control Center for Soft Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="/dash/assets/js/soft-ui-dashboard.min.js?v=1.0.3"></script>
  @yield('custom_script')
